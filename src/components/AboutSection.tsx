    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center gap-10 sm:gap-14 md:gap-16">
        ...
        <div className="flex flex-col items-center gap-16 sm:gap-20 md:gap-24">
          <AnimatedText
            text="Software Engineering student at GIKI, currently in my 5th semester. I enjoy building software that solves real-world problems—from C++ projects like compression and encryption tools to full-stack web applications with databases and authentication. I'm currently strengthening my skills in C++, JavaScript, and backend development, while also exploring DevOps concepts such as Docker, Linux, and CI/CD through academic projects. Always eager to learn, collaborate, and grow as a software engineer."
